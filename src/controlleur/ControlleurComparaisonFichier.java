...
/**
 * Controlleur du cas comparaison de fichier. Cette classe contient les méthodes permettant
 * de comparer un fichier donné avec ceux de la base de fichier.
 * @author sebastien
 *
 */
public class ControlleurComparaisonFichier {
	...
	/**
	 * Méthode principal calculant le pourcentage de similaritée entre le fichier donne et les fichiers 
	 * de la base du même type.
	 * @param chemin
	 * @param type
	 * @return resultat
	 */
	...
	/**
	 * Méthodes permettant de comparer deux fixhier image entre eux
	 * Pour l'instant ces méthodes retourne des résultats prédéfini
