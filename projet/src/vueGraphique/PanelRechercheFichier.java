...
public class PanelRechercheFichier extends JPanel {
	...
	public PanelRechercheFichier(){
		...
		this.panelBar.add(new JButton("1"));
		...
		this.panelTypeFic.add(new JButton("1"));
		this.panelTypeFic.add(new JButton("1"));
		this.panelTypeFic.add(new JButton("1"));
		this.panelTypeFic.add(new JButton("1"));
		this.panelTypeFic.add(new JButton("1"));
		...
		this.add(new JButton("1"));this.add(new JButton("1"));this.add(new JButton("1"));
		this.add(new JButton("1"));this.add(new JButton("1"));this.add(new JButton("1"));

		this.add(new JButton("1"));this.add(panelBar);this.add(new JButton("1"));
		this.add(new JButton("1"));this.add(panelTypeFic);this.add(new JButton("1"));
		this.add(new JButton("1"));this.add(new JButton("1"));this.add(new JButton("1"));
		this.add(new JButton("1"));this.add(new JButton("1"));this.add(new JButton("1"));
